...
(function(c, a, b) {
    ...
    c.extend(b.Client.prototype, {
        ...
        openSession: function(h, k, i, j, m) {
            ...
            if (!f) {
                if (k !== undefined) {
                    l._hashEncoderPass = a.hashEncoder(k)
                }
                l._nonce = "";
        ...
        restoreFromCookie: function() {
            if (a.opt.GUI_SAVE_LOGIN_OPT && this._options.cookie) {
                ...
                if (e) {
                        ...
                        if (e.sess_id != "0") {
                            ...
                            if (e.basic) {
                                ...
                                if (a.opt.GUI_ACTIVATE_SHA512ENCODE_OPT === 1) {
                                    this._ha1 = e.ha1.substr(0, 10) + e.ha1.substr(10 + 128);
                                    this._hashEncoderPass = e.ha1.substr(10, 128)
                                } else {
                                    this._ha1 = e.ha1.substr(0, 10) + e.ha1.substr(10 + 32);
                                    this._hashEncoderPass = e.ha1.substr(10, 32)
                                }
                                this._nonce = e.nonce
                            }
                        }
                    ...
                    if (this.isConnected() && a.opt.GUI_RESET_NOTIFICATION) {
        ...
        saveToCookie: function() {
            if (a.opt.GUI_SAVE_LOGIN_OPT && this._options.cookie) {
                ...
                if (e) {
                    ...
                    f.ha1 = this._ha1;
                    if (a.opt.GUI_ACTIVATE_SHA512ENCODE_OPT === 1) {
                        f.ha1 = this._ha1.substr(0, 10) + this._hashEncoderPass + this._ha1.substr(10)
                    } else {
                        f.ha1 = this._ha1.substr(0, 10) + this._hashEncoderPass + this._ha1.substr(10)
                    }
                    f.nonce = this._nonce
                }
                if (a.opt.GUI_COOKIE_NOEXPIRE_OPT) {
                    d = ""
                } else {
        ...
        hashPassword: function(d) {
            return a.hashEncoder(d)
        },
        getPassword: function() {
            return this._hashEncoderPass
        },
        addPage: function(d) {
    ...
    c.extend(b.Request.prototype, {
                    ...
                    p = function() {
                        ...
                        if (k._uploadFiles.length) {
                            var u = c('<form action="' + a.opt.XMO_REMOTE_HOST + '/cgi/upload" method="POST" enctype="multipart/form-data"></form>').appendTo("body").hide().append(k._uploadFiles).ajaxSubmit({
                                ...
                                success: function(A, y, z) {
                                    u.remove();
                                    s(A);
                                    k._uploadFiles = c([])
                                },
                                error: function(y, z, A) {
                                    u.remove();
                                    r(y, z, A);
                                    k._uploadFiles = c([])
                                }
                            ...
                            var w = new Object();
                            w.type = "POST";
                            w.url = a.opt.XMO_REMOTE_HOST + "/cgi/json-req";
                            w.dataType = "json";
                            w.data = v;
                            w.async = !d.synchronous;
                            w.timeout = d.ajaxTimeout * 1000;
                            w.cache = false;
                            w.success = s;
                            w.error = r;
                            if (a.opt.GUI_CHANGE_REQUEST_HEADER_OPT) {
                                w.contentType = "charset=" + a.opt.GUI_CUSTOM_CHARSET_OPT;
                                w.beforeSend = function(y) {
                                    y.setRequestHeader("Accept", "application/json; charset=" + a.opt.GUI_CUSTOM_CHARSET_OPT)
                                }
                            }
                            k.ajaxRequest = c.ajax(w)
                        }
                    }
                    ;
                    p()
        ...
        setValue: function(e, i, d, g, f) {
            var h = this._extendOptions("action", d, g, f);
            if (!a.opt.GUI_NO_XSS_FUNCTION_OPT) {
                if (e != undefined && e.indexOf("WiFi") == -1 && e.indexOf("DynamicDNS") == -1 && e.indexOf("Password") == -1) {
                    i = c.gui.fval(i);
                    i = c.gui.fec(i)
                }
            }
        ...
        firmwareUpgrade: function(f, k, d, h, g) {
            var j = this._extendOptions("action", d, h, g)
              ...
              , i = {
                ...
                GUI: "2 Web Content",
                "X SAGEMCOM MESH": "X SAGEMCOM MESH"
            };
            if (j.fileType.charAt(0) == "X") {
                i[j.fileType] = j.fileType
            }
        ...
        docsisFirmwareUpgrade: function(f, k, d, h, g) {
            var j = this._extendOptions("action", d, h, g)
              , e = c(k)
              , i = {
                DOCSIS30_FIRMWARE: "1 Docsis30 Firmware Upgrade Image",
                DOCSIS31_FIRMWARE: "2 Docsis31 Firmware Upgrade Image"
            };
            if (!a.isString(j.fileType) || !i[j.fileType]) {
                j.fileType = "DOCSIS30_FIRMWARE"
            }
            e.after(e.clone(true)).hide();
            this._uploadFiles = c(this._uploadFiles.add(e));
            this.remoteCall(f, "DownloadDocsisFirmware", {
                id: "0",
                fileType: i[j.fileType],
                url: "file://" + e.attr("name"),
...
jQuery.extend(jQuery.gui, {
    ...
    XMO_FILE_AUTHENTIFICATION_ERR: 16777319,
    XMO_LAST_ERR: 16777321
});
